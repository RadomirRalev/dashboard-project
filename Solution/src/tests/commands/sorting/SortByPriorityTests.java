...
public class SortByPriorityTests {
    ...
    public void before() {
        ...
        testCommand = new SortAllWorkItemsByPriority(functionalsRepository);
        steps = new ArrayList<>();
        steps.add("baluche1");
        steps.add("Baluche2");
    ...
    @Test
    public void sortByPriority_should_showSortedList_when_called() {
        //Arange
        List<String> testList = new ArrayList<>();
        ...
        str.append("Person assigned: pesho\n");
