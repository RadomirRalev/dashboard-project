...
import commands.actions.workitem.ListWorkItems.ListAllWorkItemsByType;
...
public class ListAllWorkItemsByTypeTests {
    ...
    public void before() {
        ...
        testCommand = new ListAllWorkItemsByType(functionalsRepository);
    }
