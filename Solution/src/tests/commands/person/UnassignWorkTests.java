...
import commands.actions.person.UnassignWorkFromPerson;
...
public class UnassignWorkTests {
    ...
    public void before() {
        ...
        testCommand = new UnassignWorkFromPerson(functionalsRepository);
    }
    ...
    public void check_If_WorkIsRemovedFromPersonWhenInputIsValid() {
        ...
        person.unassignWork(0);

        //Assert
        Assert.assertEquals(0, person.getAssignedWork().size());
    }
}
